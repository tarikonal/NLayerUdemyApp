    ...
    internal class ProductSeed : IEntityTypeConfiguration<Product>
    {
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            builder.HasData(
                ...
                new Product { Id = 4, Name = "Kitap 1", CategoryId = 2, Price = 700, Stock = 220, CreatedDate = DateTime.Now },
                new Product { Id = 5, Name = "Kitap 2", CategoryId = 2, Price = 900, Stock = 120, CreatedDate = DateTime.Now }
            );
        }
    }
}
